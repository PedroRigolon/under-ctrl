...
export default function Navbar(){
    return (
        ...
        <header className="flex fixed bottom-0 md:bottom-auto md:top-0 w-full min-h-navbar-desktop bg-components md:items-center justify-center">
            <nav className="md:hidden w-full h-full flex justify-between items-center max-[375px]:px-gutter-mobile-sm px-gutter-mobile sm:px-gutter-sm sm:py-4">
            ...
            <nav className="hidden md:flex w-full h-full justify-between items-center px-gutter-mobile lg:max-w-[1200px] py-4">
                <Brand />
